...
class HinduMarriageActRAG:
    ...
    def add_hindu_marriage_act_documents(self, json_file_path):
        ...
        try:
            ...
            documents = self.load_hindu_marriage_act_json(hindu_marriage_act_full)
...
if __name__ == "__main__":
    ...
    GOOGLE_API_KEY = "AlzaSyBzlUN73P55UkxPNwpB95-T51sJtTBfq6M"
    
    try:
        # Initialize RAG system
        print("🚀 Initializing Hindu Marriage Act RAG System...")
        rag = HinduMarriageActRAG(AlzaSyBzlUN73P55UkxPNwpB95-T51sJtTBfq6M)
        
        # Load Hindu Marriage Act data
        # Replace with your actual JSON file path
        hindu_marriage_act_full= "hindu_marriage_act_full.json"
        
        print(f"\n📚 Loading Hindu Marriage Act from {C:\Users\ADMIN\OneDrive\Desktop\code\legalAID\kigga\data\hindu_marriage_act_full.json}...")
        rag.add_hindu_marriage_act_documents(C:\Users\ADMIN\OneDrive\Desktop\code\legalAID\kigga\data\hindu_marriage_act_full.json)
