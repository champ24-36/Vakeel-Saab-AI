...
def main():
    ...
    if not args.text_fields:
        args.text_fields = analysis['suggested_text_fields']
        print(f"⚠️  No --text-fields provided. Using suggested: {args.text_fields}")

    if not args.metadata_fields:
        args.metadata_fields = analysis['suggested_metadata_fields']
    print("\n📄 Creating documents...")
    print("\n🧾 Using these fields:")
    print("Text fields:", args.text_fields)
    print("Metadata fields:", args.metadata_fields)
    ...
    print("🧠 VectorStore initialized:", rag.vector_manager.vector_store is not None)
